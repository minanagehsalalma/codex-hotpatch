...
const CLEAN_CLIENT_0124_SNIPPET = `struct CurrentClientSetup {
    auth: Option<CodexAuth>,
    api_provider: ApiProvider,
    api_auth: SharedAuthProvider,
}
...
test("applyClientRuntimeRewrites patches the upstream 0.124 runtime layout and is idempotent", () => {
  const first = applyClientRuntimeRewrites(CLEAN_CLIENT_0124_SNIPPET);
